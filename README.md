About power-grid-model-io-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/power-grid-model-io-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/power-grid-model-io-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add power-grid-model-io
# for installing globally
pixi global install power-grid-model-io
```
...
It is possible to list all of the versions of `power-grid-model-io` available on your platform:
...
```
pixi search power-grid-model-io --channel conda-forge
```
